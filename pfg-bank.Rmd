...
```{r}
exhibit2[which.max(exhibit2$pred_150),c("offer", "apr", "fixed_var", "annual_fee", "pred_150")]
exhibit2[which.max(exhibit2$pred_200),c("offer", "apr", "fixed_var", "annual_fee", "pred_200")]
exhibit2[which.max(exhibit2$pred_250),c("offer", "apr", "fixed_var", "annual_fee", "pred_250")]
