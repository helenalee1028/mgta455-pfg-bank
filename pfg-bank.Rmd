...
* 3. Higher annual fee also means higher projected LTV, as the fixed annual fee of \$20 is guranteed revenues for banks. Translated to customer LTV, it's equivalent to \$21.
...
For most of the case, logistic regression, neural network and emsembl have equal predictive power in terms of auc. Logistic regression is slightly better. Therefore this is our final choice for each group of customers. 
